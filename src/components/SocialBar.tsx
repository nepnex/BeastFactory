  ...
  return (
    <div className="fixed right-6 bottom-8 z-40 hidden sm:flex flex-col gap-3 group">
      <div className="glass-panel p-2.5 rounded-2xl flex flex-col gap-3 shadow-2xl border border-neutral-800 transition-all duration-300">
        <a href={GYM_INFO.facebook} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-300 hover:text-white hover:bg-[#1877F2] hover:border-[#1877F2] hover:scale-110 transition-all" title="Facebook">
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
          </svg>
        </a>
        <a href={GYM_INFO.instagram} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-300 hover:text-white hover:bg-gradient-to-tr hover:from-amber-500 hover:via-rose-500 hover:to-purple-600 hover:border-transparent hover:scale-110 transition-all" title="Instagram">
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <a href={GYM_INFO.tiktok} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-xl bg-neutral-900 border border-neutral-800 flex items-center justify-center text-neutral-300 hover:text-white hover:bg-black hover:border-neutral-700 hover:scale-110 transition-all" title="TikTok">
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
