              ...
              <form onSubmit={handleSave} className="space-y-4 text-xs">
                ...
                <div className="pt-2 border-t border-neutral-800 space-y-3">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="e.g. beast-gym-bottle" value={formData.slug || ''} onChange={(e) => setFormData({ ...formData, slug: e.target.value })} className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-2 text-white" />
                  </div>
                  <div>
                    <label className="block text-neutral-400 font-semibold mb-1">SEO TITLE</label>
                    <input type="text" placeholder="Custom Product Page Title" value={formData.seoTitle || ''} onChange={(e) => setFormData({ ...formData, seoTitle: e.target.value })} className="w-full bg-neutral-900 border border-neutral-800 rounded-xl px-4 py-2 text-white" />
                  </div>
                  <div>
