...
import { PROGRAMS, SERVICES } from '../data/gymData';
        ...
        {PROGRAMS.map((prog, index) => (
          ...
          >
            ...
            <div className="w-full lg:w-1/2 space-y-6">
              <div>
                <span className="text-xs font-bold text-[#e8272a] uppercase tracking-widest">{prog.category}</span>
                <h2 className="font-heading text-4xl text-white mt-1">{prog.title}</h2>
                <p className="text-neutral-300 text-sm mt-3 leading-relaxed">{prog.description}</p>
              </div>
              ...
              <div className="pt-4 border-t border-neutral-800 flex items-center justify-between">
                <span className="text-xs text-neutral-400">{prog.schedule}</span>
